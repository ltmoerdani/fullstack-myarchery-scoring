// adapted component - removed Next.js directive
...
interface TargetSettingsPageProps { onBack?: () => void; }

export default function TargetSettingsPage({ onBack }: TargetSettingsPageProps) {
          ...
          <div>
            <div className="flex items-center gap-2 mb-1">
              {onBack ? (
                ...
                <span className="p-1 rounded text-gray-400"><ChevronLeft size={20} /></span>
              )}
